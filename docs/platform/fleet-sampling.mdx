...
| --- | --- | --- | --- |
| Android | Monitoring | No hourly heartbeats | [Batterystats](/docs/android/android-builtin-metrics#battery-and-related-metrics), [Custom Metrics](/docs/android/android-custom-metrics) and [Custom Events](/docs/android/custom-events) are uploaded every 2h |
