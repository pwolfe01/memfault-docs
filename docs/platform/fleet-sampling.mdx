...
corresponding [Device Details](/docs/platform/inspecting-a-device#device-details) page, select _Fleet Sampling Resolutions_ and click on the edit icon <DeviceDetailEditButton/> next to the resolution value.
