...
| --- | --- | --- | --- |
| Android | Monitoring | Only periodic device check-ins | [Batterystats](/docs/android/android-builtin-metrics#battery-and-related-metrics), [Custom Metrics](/docs/android/android-custom-metrics) and [Custom Events](/docs/android/custom-events) are uploaded every 2h |
| Android | Debugging | No crash collection | Crash reports (via Bug Reports or Caliper) and reboot reasons are collected |
...
Please also see [Rate Limits](/docs/platform/rate-limiting/) page as collection of these items are subject to rate limiting. 
