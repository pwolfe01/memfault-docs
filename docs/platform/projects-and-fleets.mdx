...
- Deploy new firmware/software updates to parts of your
  [Android](../android/android-releases-integration-guide.mdx), 
  [MCU](../mcu/releases-integration-guide.mdx) or [Linux](../linux/linux-releases-integration-guide) Fleet
...
When using any time-related criteria to describe a device set (for example,
"Last Seen" or "Historical Data" filters), the "Start date" and "End date"
values are stored into the Device Set as relative to the time of the query, as
depicted below:

![](/img/docs/platform/device-set-criteria-relative-time.svg)
