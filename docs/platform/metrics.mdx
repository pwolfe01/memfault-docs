...
- for Linux: [Linux Custom Metrics](/docs/linux/linux-custom-metrics)
...
1. using the Metrics APIs
   ([MCU](/docs/mcu/metrics-api)/[Android](/docs/android/android-custom-metrics)/[Linux](/docs/linux/linux-custom-metrics))
2. using the REST API
