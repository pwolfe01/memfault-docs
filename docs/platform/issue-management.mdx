...
## Hiding of Issues with zero Traces

As traces are deleted after 60 days, Memfault will hide the related Issues automatically. This
helps declutter your dashboards so that only relevant Issues are displayed.
