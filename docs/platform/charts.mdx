...
their occurrence (as a count of Traces of each Issue) over time. They share
some of the features of Metric Charts, including [Comparison
...
To create an Issue Chart, first go to **Issues** and perform a search to filter
down the results. Then, click on **Save as Issue Chart**.
