...
[Software Version](platform/software-version-hardware-version.mdx)
documentation.
...
A basic example OTA agent application can be found on [Memfault's Github](https://github.com/memfault/aosp-ota-example).
Be sure to check the `README` and note the limitations of this example code.
...
will be part of this cohort. To pre-create devices assigned to a specific cohort
check out our [api-docs](https://api-docs.memfault.com/).
