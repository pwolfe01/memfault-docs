...
- Reporting [Custom Metrics][docs-linux-metrics].
- [Over-the-air (OTA) updates][docs-linux-ota].

## Useful links

- The [source for the Memfault Linux SDK][source-sdk].
...
- Currently, our SDK is centered around [Yocto][yocto-homepage] and is verified
  to work on [`4.0 kirkstone`][yocto-kirkstone].
...
[source-yocto-memfault-device-info-example]:
  https://github.com/memfault/memfault-linux-sdk/blob/main/meta-memfault-example/recipes-memfault/memfault-device-info/memfault-device-info.bb
[source-yocto-memfaultd-conf-example]:
  https://github.com/memfault/memfault-linux-sdk/blob/main/meta-memfault-example/recipes-memfault/memfaultd/memfaultd.bbappend
[source-memfaultd]:
...
[docs-linux-metrics]: /docs/linux/linux-custom-metrics
