...
generated by our [recommended configuration](#recommended-configuration) gives
CollectD plenty of space to fit a payload generated by our
[recommended configuration](#recommended-configuration). A typical payload grows
up to 20KiB.
