...
| [Software Module / Artifact](https://www.eclipse.org/hawkbit/ui/#artifact-management)            | [OTA Payload](/docs/platform/ota#adding-an-ota-payload-to-a-release)           | The combination of hawkBit Software Modules and Artifacts describe a hiararchy of files to be distributed to devices. A Memfault Release contains OTA Payload, which is specific to the device's hardware version. |
| [Distribution / Rollout](https://www.eclipse.org/hawkbit/concepts/datamodel)                     | [Release][memfault-release-management-ui]                                      | A hawkBit Distribution is a versioned set of Software Modules. A Memfault Release is a versioned set of OTA Payloads.                                                                                              |
...
| [Gateway Security Token Authentication](https://www.eclipse.org/hawkbit/concepts/authentication) | [Project key](/docs/linux/linux-releases-integration-guide#project-key)        | Authenticating a device to the update server.                                                                                                                                                                      |
