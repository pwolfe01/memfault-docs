...
program. Refer to our [coredump guide][docs-coredump-strategies] for more
information.
...
[docs-coredump-strategies]:
  /docs/linux/coredumps#controlling-which-memory-regions-are-captured-in-coredumps
...
[docs-man-core]: https://man7.org/linux/man-pages/man5/core.5.html
