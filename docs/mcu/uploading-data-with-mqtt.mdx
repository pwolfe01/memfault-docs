...
[chunk REST endpoint](https://api-docs.memfault.com/?version=latest#66b0e390-2c3e-4c0d-b6c2-836a287b9e5f), some additional work is required to forward the data from the MQTT
server to Memfault.
