---
id: nordic-nrf-connect-sdk-guide
...
some
[excellent documentation](https://docs.nordicsemi.com/bundle/ncs-2.4.2/page/nrf/external_comp/memfault.html)
on how to integrate Memfault in your existing nRF Connect SDK project, together
with a
[sample integration project](https://docs.nordicsemi.com/bundle/ncs-2.4.2/page/nrf/samples/debug/memfault/README.html).
...
[nRF Connect SDK Environment](https://docs.nordicsemi.com/bundle/ncs-2.4.2/page/nrf/getting_started.html)
...
See the
[nRF Connect Docs](https://docs.nordicsemi.com/bundle/ncs-2.4.2/page/nrf/external_comp/memfault.html#configuration_files)
...
<https://docs.nordicsemi.com/bundle/ncs-2.4.2/page/nrf/libraries/bluetooth_services/services/mds.html>

There is also a sample application, "Bluetooth LE: Peripheral Memfault
Diagnostic Service (MDS)", documented here:

<https://docs.nordicsemi.com/bundle/ncs-2.4.2/page/nrf/samples/bluetooth/peripheral_mds/README.html>
...
- [`CONFIG_MEMFAULT_NCS_LTE_METRICS`](https://docs.nordicsemi.com/bundle/ncs-1.9.2-dev1/page/kconfig/CONFIG_MEMFAULT_NCS_LTE_METRICS.html)
- [`CONFIG_MEMFAULT_NCS_STACK_METRICS`](https://docs.nordicsemi.com/bundle/ncs-1.9.2-dev1/page/kconfig/CONFIG_MEMFAULT_NCS_STACK_METRICS.html)
...
- [nRF52/nRF53 example Memfault integration](https://github.com/memfault/memfault-firmware-sdk/tree/1.3.2/examples/nrf-connect-sdk/nrf5)
- [nRF9160 example Memfault integration](https://github.com/memfault/memfault-firmware-sdk/tree/1.3.2/examples/nrf-connect-sdk/nrf9160)
- [Nordic maintained nRF9160 example Memfault integration](https://github.com/nrfconnect/sdk-nrf/tree/v2.4.2/samples/debug/memfault)
- [Nordic maintained Asset Tracker v2 Application for nRF9160](https://github.com/nrfconnect/sdk-nrf/tree/v2.4.2/applications/asset_tracker_v2)

  - see the documentation for
    [how to build with Memfault enabled](https://docs.nordicsemi.com/bundle/ncs-2.4.2/page/nrf/applications/asset_tracker_v2/doc/debug_module.html)

Nordic Memfault Documentation:

- [nRF Connect SDK documentation on built-in Memfault Firmware SDK integration](https://docs.nordicsemi.com/bundle/ncs-2.4.2/page/nrf/libraries/debug/memfault_ncs.html)
...
```yaml reference title="nrf/west.yml"
https://github.com/nrfconnect/sdk-nrf/blob/75adfe8909fbac1c2e0ede465448d1ce2821dfa9/west.yml#L224-L227
```
