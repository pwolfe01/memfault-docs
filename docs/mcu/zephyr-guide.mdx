...
## Memfault Zephyr Log Backend

TODO

(deferred vs immediate, compact logs, etc)

## Configuring Coredump Regions

TODO

MEMFAULT_COREDUMP_COLLECT_BSS_REGIONS

MEMFAULT_RAM_BACKED_COREDUMP_SIZE

MEMFAULT_COREDUMP_COLLECT_DATA_REGIONS
...
> Note: on boards that do not reserve a UART for console, an alternative is RTT.
> See more information here:
>
> - <https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.1.1/nrf/gs_testing.html#how-to-use-rtt>
> - <https://blog.golioth.io/use-rtt-with-zephyr-when-console-output-via-uart-just-isnt-convenient/>
...
1. Zephyr example with networking enabled, targeting the
   ...
   - [https://github.com/memfault/memfault-firmware-sdk/tree/0.33.5/examples/zephyr/stm32l4_disco](https://github.com/memfault/memfault-firmware-sdk/tree/0.33.5/examples/zephyr/stm32l4_disco)

2. Non-networked example, can be used with any Cortex-M board:

   - [https://github.com/memfault/memfault-firmware-sdk/tree/0.33.5/examples/zephyr/qemu](https://github.com/memfault/memfault-firmware-sdk/tree/0.33.5/examples/zephyr/qemu)
