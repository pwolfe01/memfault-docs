...
- Enabled App built with Memfault SDK
- Created Memfault Project
- Registered Device in Project
- Uploaded Coredump
- Uploaded Metrics

### Requirements list

- Installed ESP-IDF installed
- Created Git account
- Installed `Pyelftools` Python package

### Time required to complete the integration
