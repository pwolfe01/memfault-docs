...
releases ranging from v1.4.0 up to v2.0.2. All versions of the nRF Connect SDK
...
released some
[excellent documentation](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.0.2/nrf/libraries/others/memfault_ncs.html)
on how to integrate Memfault in your existing nRF Connect SDK project, together
with a
[sample integration project](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.0.2/nrf/samples/nrf9160/memfault/README.html#memfault-sample).
...
[nRF Connect SDK Environment](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.0.2/nrf/getting_started.html)
...
See the
[nRF Connect Docs](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.0.2/nrf/libraries/others/memfault_ncs.html#configuration-files)
...
the Memfault Diagnostic Service, which is a BLE GATT service designed to enable
exporting Memfault data in a standardized way.

Nordic has detailed documentation on the Memfault Diagnostic service here:

<https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.1.0/nrf/libraries/bluetooth_services/services/mds.html>

There is also a sample application, "Bluetooth: Peripheral Memfault Diagnostic
Service (MDS)", documented here:

<https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.1.0/nrf/samples/bluetooth/peripheral_mds/README.html>

Nordic and Memfault provide the following BLE gateways for testing the MDS implementation:

- the Python MDS BLE gateway script, from the nRF-Connect SDK: <https://github.com/nrfconnect/sdk-nrf/tree/v2.1.0/scripts/memfault>

- a WebBluetooth browser-based tool, from Memfault: <https://mflt.io/mds>

- iOS and Android mobile applications and open-source libraries:
  - Android app: <https://play.google.com/store/apps/details?id=no.nordicsemi.memfault>
  - iOS app: <https://apps.apple.com/us/app/nrf-memfault/id1641119282>
  - Android library: <https://github.com/NordicSemiconductor/Android-Memfault-Library>
  - iOS library: <https://github.com/NordicSemiconductor/IOS-Memfault-Library>

For a quick test, we recommend using the "Bluetooth: Peripheral Memfault
...
[sample integration project](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/1.9.1/nrf/samples/nrf9160/memfault/README.html#memfault-sample)
...
<!--
  note- in v2.0.0 of NCS, these variables are no longer linkable in the fancy
  kconfig interactive searcher they added:
  https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.0.2/kconfig/index.html

  I mentioned it to Nordic to hopefully fix, for the meantime use the working
  v1.9.2 links.
-->

- [`CONFIG_MEMFAULT_NCS_LTE_METRICS`](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/1.9.2/kconfig/CONFIG_MEMFAULT_NCS_LTE_METRICS.html)
- [`CONFIG_MEMFAULT_NCS_STACK_METRICS`](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/1.9.2/kconfig/CONFIG_MEMFAULT_NCS_STACK_METRICS.html)
...
- [nRF52/nRF53 example Memfault integration](https://github.com/memfault/memfault-firmware-sdk/tree/969baaf01e16dcec9f1ec1549f05313da366d3dd/examples/nrf-connect-sdk/nrf5)
- [nRF9160 example Memfault integration](https://github.com/memfault/memfault-firmware-sdk/tree/969baaf01e16dcec9f1ec1549f05313da366d3dd/examples/nrf-connect-sdk/nrf9160)
- [Nordic maintained nRF9160 example Memfault integration](https://github.com/nrfconnect/sdk-nrf/tree/v2.0.2/samples/nrf9160/memfault)
- [Nordic maintained Asset Tracker v2 Application for nRF9160](https://github.com/nrfconnect/sdk-nrf/tree/v2.0.2/applications/asset_tracker_v2)

  - see the documentation for
    [how to build with Memfault enabled](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.0.2/nrf/applications/asset_tracker_v2/doc/asset_tracker_v2_description.html#building-with-overlays)

Nordic Memfault Documentation:

- [nRF Connect SDK documentation on built-in Memfault Firmware SDK integration](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.0.2/nrf/libraries/others/memfault_ncs.html)
...
- <https://github.com/nrfconnect/sdk-nrf/blob/v2.0.2/west.yml#L169-L172>
