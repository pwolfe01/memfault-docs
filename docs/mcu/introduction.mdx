...
4. The Memfault cloud automatically groups similar traces together into issues.
   Notifications are used to let you know when problems are detected. From the
   Memfault web application, issues can be drilled into and overall fleet health
...
| [nRF9160 DK](https://www.nordicsemi.com/Products/Development-hardware/nrf9160-dk)                                                                                                                                                                                                                                        | [<img src="/img/docs/mcu/nRF59160-DK-prod_page.webp" width="200px" />](https://www.nordicsemi.com/Products/Development-hardware/nrf9160-dk)                                                           | Nordic maintains an example app included with the nRF Connect SDK:<br/> - [nRF-Connect SDK samples/debug/memfault](https://docs.nordicsemi.com/bundle/ncs-2.4.2/page/nrf/samples/debug/memfault/README.html)<br/><br/>The Memfault SDK includes a basic example:<br/>- [examples/nrf-connect-sdk/nrf9160](https://github.com/memfault/memfault-firmware-sdk/tree/73fab8656b17bde6efa11bf78fbe155a8dbabf78/examples/nrf-connect-sdk/nrf9160/memfault_demo_app) |
